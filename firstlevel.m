...
%% variables
analysisname = 'mnifield_shen368_n58';
projname = 'cpm_pd';
...
%% batch
clear batch;
batch.filename = fullfile(['/Users/atyn/Desktop/data/mr/ing/cpm_pd/analysis/' analysisname, '.mat']);         
batch.Setup.isnew = 1;
...
%% rois
batch.Setup.rois.files{1} = '/Users/atyn/spm12/toolbox/conn/rois/Shen368.nii';
