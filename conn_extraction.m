...
projname = 'projname';
projdir = ['/path/to/data/' projname];
bidsdir = [projdir '/bids'];
boldname = 'boldname.nii';
anatname = 'anatname.nii';
fmapname = 'fmapname_epi.nii';
TR = TR;
...
%% batch
clear batch;
batch.filename = fullfile(['/path/to/bidsdir/' analysisname, '.mat']);         
batch.Setup.isnew = 1;
...
%% rois
batch.Setup.rois.files{1} = '/path/to/shen368.nii';
